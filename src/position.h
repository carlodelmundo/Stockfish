...
inline Piece Position::moved_piece(Move m) const { return board[from_sq(m)]; }
...
inline Score Position::psq_score() const { return st->psq; }
...
inline bool Position::opposite_bishops() const {
  return pieceCount[W_BISHOP] == 1 && pieceCount[B_BISHOP] == 1 &&
